...
use tradingflow::flow::{Adapt, Clock, Const, PyClassOperator, PyParams, Record};
...
fn main() {
    ...
    let turnover_series = b.push(Adapt::new(Record::new(clock.clone())), turnover);
    ...
    let series: &Series<f64> = g.cell(turnover_series);
