...
mod tests {
    ...
    fn negate_vector() {
        ...
        Negate::compute(&mut s, (&a,), &mut o, 1);
    ...
    fn subtract_scalar() {
        ...
        Subtract::compute(&mut s, (&a, &b), &mut o, 1);
        assert_eq!(o.as_slice(), &[13.0]);
    }
    ...
    fn multiply_scalar() {
        ...
        Multiply::compute(&mut s, (&a, &b), &mut o, 1);
    ...
    fn divide_scalar() {
        ...
        Divide::compute(&mut s, (&a, &b), &mut o, 1);
