"""Abstract mean-return predictor operator (flowops host contract)."""
...
class MeanPredictor[T]:
    ...
    Output: ArrayView, shape ``(num_stocks,)`` (per-stock prediction).
    ...
    predict_fn : (state, features, params) -> predictions
