"""Self-contained validation tests for the ported `flowops.metrics` operators.

Run with:
    PYTHONPATH=python .venv-ft/Scripts/python.exe python/flowops/tests/test_metrics.py
"""
...
from flowops.metrics.variance.minimum_variance import build as build_mv
...
def main():
    ...
    print("\nAll flowops.metrics tests passed.")
