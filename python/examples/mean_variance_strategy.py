...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--begin", type=np.datetime64, required=True, help="start date (e.g. 2024-01-01)")
    ...
    assert first_ns_opt is not None and last_ns_opt is not None
