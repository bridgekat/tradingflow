"""Self-contained validation tests for the ported `tradingflow.predictors` group.
...
Run with:
    PYTHONPATH=python .venv-ft/Scripts/python.exe python/tradingflow/tests/test_predictors.py
"""
...
from tradingflow.predictors.mean import sample as mean_sample
from tradingflow.predictors.mean import single_feature as mean_single_feature
from tradingflow.predictors.mean import linear_regression as mean_lr
from tradingflow.predictors.mean import ridge as mean_ridge
from tradingflow.predictors.mean import lasso as mean_lasso

from tradingflow.predictors.variance import sample as var_sample
from tradingflow.predictors.variance import single_index as var_single_index
from tradingflow.predictors.variance import shrinkage as var_shrinkage
...
def test_mean_subsample():
    ...
    from tradingflow.predictors.mean._base import pool_and_subsample
...
def test_incremental_equivalence():
    ...
    """
    from tradingflow.predictors.mean import linear_regression as o_lr
    from tradingflow.predictors.mean import ridge as o_ridge
    from tradingflow.predictors.mean import incremental_linear_regression as i_lr
    from tradingflow.predictors.mean import incremental_ridge as i_ridge
...
def test_incremental_all_samples():
    ...
    """
    from tradingflow.predictors.mean import incremental_ridge as i_ridge
    from tradingflow.predictors.mean._incremental import _solve_standardized
