...
original default. See `tradingflow.predictors.mean._incremental` for the design.
...
from tradingflow.predictors.mean._incremental import IncrementalMeanPredictor, rls_pool_factory
