...
//! operators, like [`feature::forward_adjust`](operators::feature::forward_adjust),
...
//! and custom ones [written in Rust](graph) or [Python](python), but the
//! overall structure stays the same.
//!
//! # Arrays and series
//!
