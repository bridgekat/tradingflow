...
pub fn atan2<T: Scalar + Float, const N: usize>() -> impl Segment<
...
pub fn minf<T: Scalar + Float, const N: usize>() -> impl Segment<
    Inputs = (ArrayPort<T, N>, ArrayPort<T, N>),
    Outputs = ArrayPort<T, N>,
    Context = Instant,
> {
...
pub fn maxf<T: Scalar + Float, const N: usize>() -> impl Segment<
    Inputs = (ArrayPort<T, N>, ArrayPort<T, N>),
    Outputs = ArrayPort<T, N>,
    Context = Instant,
> {
