...
- Examples live in [`examples/`](examples/) (Rust, on the `flowgraph` engine) and read A-shares data generated by the vendored [a-shares-crawler](extern/a-shares-crawler); see [`examples/README.md`](examples/README.md).
