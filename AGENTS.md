...
- Examples live in [`examples/`](examples/) (Rust, on the `flowgraph` engine) and read A-shares data generated by [a-shares-crawler](https://github.com/bridgekat/a-shares-crawler); see [`examples/README.md`](examples/README.md).
